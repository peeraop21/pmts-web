...
{
    public class MoBoardAlternativeAPIRepository : IMoBoardAlternativeAPIRepository
    {
        private readonly string _actionName = "MoBoardAlternative";

        public string GetMoBoardAlternativeList(string factoryCode, string token)
        {
        ...
        public void SaveMoBoardAlternative(string jsonString, string token)
        {
        ...
        public void UpdateMoBoardAlternative(string jsonString, string token)
        {
        ...
        public void DeleteMoBoardAlternative(string jsonString, string token)
        {
