...
{
    public class PMTsNewDbContextAPIRepository : IPMTsNewDbContextAPIRepository
    {
        private readonly string _actionName = "PMTsNewDbContext";

        public string GetPMTsNewDbContextList(string factoryCode, string token)
        {
        ...
        public void SavePMTsNewDbContext(string jsonString, string token)
        {
        ...
        public void UpdatePMTsNewDbContext(string jsonString, string token)
        {
        ...
        public void DeletePMTsNewDbContext(string jsonString, string token)
        {
