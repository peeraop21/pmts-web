...
{
    public class PpcWorkTypeAPIRepository : IPpcWorkTypeAPIRepository
    {
        private readonly string _actionName = "PpcWorkType";

        public string GetPpcWorkTypeList(string factoryCode, string token)
        {
