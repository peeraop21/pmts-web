...
{
    public class JoinCharacterAPIRepository : IJoinCharacterRepository
    {
        private readonly string _actionName = "JoinCharacter";

        public string GetJoinCharacterList(string factoryCode, string token)
        {
