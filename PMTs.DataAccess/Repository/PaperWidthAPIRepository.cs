...
{
    public class PaperWidthAPIRepository : IPaperWidthAPIRepository
    {
        private readonly string _actionName = "PaperWidth";

        public string GetPaperWidthList(string factoryCode, string token)
        {
        ...
        public void SavePaperWidth(string factoryCode, string jsonString, string token)
        {
        ...
        public void UpdatePaperWidth(string factoryCode, string jsonString, string token)
        {
        ...
        public void DeletePaperWidth(string jsonString, string token)
        {
