...
{
    public class FluteLayerAPIRepository : IFluteLayerAPIRepository
    {
        private readonly string _actionName = "FluteLayer";

        public string GetFluteLayerList(string factoryCode, string token)
        {
        ...
        public void SaveFluteLayer(string jsonString, string token)
        {
        ...
        public void UpdateFluteLayer(string jsonString, string token)
        {
        ...
        public void DeleteFluteLayer(string jsonString, string token)
        {
