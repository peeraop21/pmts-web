...
{
    public class ProductionTypeAPIRepository : IProductionTypeAPIRepository
    {
        private readonly string _actionName = "ProductionType";

        public string GetProductionTypeList(string factoryCode, string token)
        {
        ...
        public void SaveProductionType(string jsonString, string token)
        {
        ...
        public void UpdateProductionType(string jsonString, string token)
        {
        ...
        public void DeleteProductionType(string jsonString, string token)
        {
