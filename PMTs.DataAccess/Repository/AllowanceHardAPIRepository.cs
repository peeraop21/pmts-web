...
{
    public class AllowanceHardAPIRepository : IAllowanceHardAPIRepository
    {
        private readonly string _actionName = "AllowanceHard";

        public string GetAllowanceHardList(string factoryCode, string token)
        {
        ...
        public void SaveAllowanceHard(string jsonString, string token)
        {
        ...
        public void UpdateAllowanceHard(string jsonString, string token)
        {
        ...
        public void DeleteAllowanceHard(string jsonString, string token)
        {
