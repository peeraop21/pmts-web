...
{
    public class HireMappingAPIRepository : IHireMappingAPIRepository
    {
        private readonly string _actionName = "HireMapping";

        public string GetAllHireMapping(string factoryCode, string token)
        {
